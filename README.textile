 ...
 * Web developers *MUST* manually remove the src attributes and change them to @data-src@, this could be easily done by any Back-End code via built-in filters in most Content Management Systems and search & replace from code editors.
